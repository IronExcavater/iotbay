...
function inputStyles(hasError: boolean, size: InputSize) {
    return clsx(
        'bg-ui-0 text-ui-900 w-full rounded border-0 px-3 text-sm ring-1 transition-[background-color,box-shadow,color] outline-none disabled:bg-ui-100 disabled:text-ui-500',
