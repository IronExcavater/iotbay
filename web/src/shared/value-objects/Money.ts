import type { ValidationResult } from '@shared/validation/base';
import { MoneyValidator } from '@shared/validation/numbers';
import { parseValue } from '@shared/value-objects/base';
