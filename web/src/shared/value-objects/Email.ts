import { EMAIL_MAX_LENGTH } from '@shared/validation/strings';
import { EmailValidator } from '@shared/validation/textual';
import { parseValue, validateValue } from '@shared/value-objects/base';
